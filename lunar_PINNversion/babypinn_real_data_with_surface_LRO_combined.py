...
# from evaluation.evaluate_run import output_dir
...
if __name__ == "__main__":
    ...
    surface_data_filename = "./data/LRO_data/combined.csv"
    ...
    plot_four_component_mollweide(
        Lunar_surface_data_loader1.phi,
        Lunar_surface_data_loader1.theta,
        Lunar_surface_data_loader1.alpha_c,
        Lunar_surface_data_loader1.B_sc,
